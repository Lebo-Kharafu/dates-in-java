...
public class Datee {
    ...
    public void setYear(int year) {
        if (year >= 1400) {
    	   this.year = year;
	    	  ...
	    	  System.out.println(year + " year out of bound  1400-...");
	    }
    ...
    public void setMonth(int month) {
        ...
        if (month <= 12 && month >= 1){
            ...
            System.out.println(month + " is a incorrect month");
        }
    }
    ...
    public void setDay(int day) {
        ...
        if( (getMonth() != 2) ){
            ...
            if( (getMonth() < 7) && (getMonth() % 2 == 0) && ((day >= 1) && (day <= 30)) ) {

            	this.day = day ;
			}
            else if(  (getMonth() < 7) && (getMonth() % 2 == 1) && ((day >= 1) && (day <= 31))  ) {
				
            	this.day = day;
			}
            else if(  (getMonth() >= 7) && (getMonth() % 2 == 0) && ((day >= 1) && (day <= 31))  ) {
            	this.day = day;
			}
            else if(  (getMonth() >= 7) && (getMonth() % 2 == 1) && ((day >= 1) && (day <= 30))  ) {
            	
            	this.day = day;
			}
            else {
				System.out.println(day + " is a incorrect day");
